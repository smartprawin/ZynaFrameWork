...
public class DataUtils {
	...
	private static int getRnum(ExcelReader xls, String testName, String sheetName) {
		int testStartRowNum=1;
		while(!xls.getCellData(sheetName, 0, testStartRowNum).equals(testName))
			testStartRowNum++;
		int colStartRowNum=testStartRowNum+1;
	...
	private static int findRowCol(ExcelReader xls, String testName, String columnName, String sheetName) {
		int testStartRowNum=1;
		while(!xls.getCellData(sheetName, 0, testStartRowNum).equals(testName)){
			testStartRowNum++;
		}
	...
	public static void addDataInExcel(ExcelReader xls, String sheetName, String testName, int dataCount, String columnName, String data) {
		int col = findRowCol(xls, testName, columnName, sheetName);
		xls.setCellData(sheetName, col , (getRnum(xls, testName, sheetName))+dataCount, data);
	}
}